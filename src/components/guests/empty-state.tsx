...
export function EmptyState({ hasFilters, onReset }: EmptyStateProps) {
  return (
    <div className="border-border/50 bg-muted/20 flex min-h-[400px] flex-col items-center justify-center rounded-md border-2 border-dashed p-8 text-center">
      ...
      <h3 className="mb-2 text-lg font-semibold">No guests found</h3>
      <p className="text-muted-foreground mb-6 max-w-sm">
        {hasFilters
          ? "We couldn't find any guests matching your search filters. Try adjusting your criteria."
          : "There are no guests added yet."}
      </p>
      {hasFilters && (
        <Button
          onClick={onReset}
